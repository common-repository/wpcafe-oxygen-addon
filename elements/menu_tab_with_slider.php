...
class Menu_Tab_With_Slider extends \Oxy_Wpcafe_El {
	...
	function render($options, $defaults, $content) {
        ...
        $shortcode = '[wpc_pro_menu_tab_with_slider '.$atts_string.']';
	...
	public function controls() {
		...
		)->setValue(array('style-1','style-2','style-3'));
		$product_query->addOptionControl(
			array(
				"type" => 'buttons-list',
		...
		$nav_menu_selector = ".wpc-nav li a";
		$nav_menu_selector_active = $nav_menu_selector.".wpc-active";
		$nav_icon = $nav_menu_selector." i, > svg path";
		$nav_icon_active = $nav_menu_selector_active." i, > svg path";
		
		$nav_menu_style->addOptionControl(
			array(
				"type" => 'buttons-list',
				"name" => esc_html__('Nav Style', 'wpcafe-oxygen-addon'),
				"slug" => 'wpc_nav_menu_style',
				'default' => 'Normal',
			)
		...
		$nav_menu_style->addStyleControls(
			array(
				array(
					"selector" => $nav_menu_selector,
					"property" => 'color',
					"condition" => 'wpc_nav_menu_style=Normal',
				),
				array(
					"selector" => $nav_menu_selector,
					"property" => 'font-size',
		...
		$nav_menu_style->addStyleControls(
			array(
				array(
					"selector" => $nav_menu_selector_active,
					"property" => 'color',
					"condition" => 'wpc_nav_menu_style=Active',
				),
				array(
					"selector" => $nav_icon_active,
					"property" => 'color',
					"condition" => 'wpc_nav_menu_style=Active',
				),
			)
		...
		$nav_menu_style->addPreset(
            "padding"," ", esc_html__("Padding","wpcafe-oxygen-addon"), $nav_menu_selector
		);

		$nav_menu_style->addPreset(
            "margin"," ", esc_html__("Margin","wpcafe-oxygen-addon"), '.wpc-nav'
		);
