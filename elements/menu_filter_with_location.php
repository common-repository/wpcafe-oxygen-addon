...
class Menu_Filter_With_Location extends \Oxy_Wpcafe_El {
	...
	function name() {
		return ' Menu Filter By Location';
	}
	...
	function render($options, $defaults, $content) {
        ...
        $shortcode = '[wpc_food_location_menu '.$atts_string.']';
	...
	public function controls() {
		...
		$product_query->addOptionControl(
			array(
				"type" => 'buttons-list',
				"name" => esc_html__('Show Delivery/prepering Time', 'wpcafe-oxygen-addon'),
