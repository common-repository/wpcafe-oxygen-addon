...
class Reservation_With_Food_Tab_View extends \Oxy_Wpcafe_El {
	...
	function name() {
		return 'Food With Reservation Tab View (Pro)';
	}
	...
	function render($options, $defaults, $content) {
        ...
        $shortcode = '[wpc_reservation_with_food wpc_food_menu_tab '.$atts_string.']';
	...
	public function controls() {
		...
		$product_query->addOptionControl(
			array(
				"type" => 'dropdown',
				"name" => esc_html__('Form Style ', 'wpcafe-oxygen-addon'),
				"slug" => 'form_style',
				'default' => 'style-1',
			)
...
new Reservation_With_Food_Tab_View();