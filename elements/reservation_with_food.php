...
class Reservation_With_Food extends \Oxy_Wpcafe_El {
	...
	function name() {
		return 'Food With Reservation (Pro)';
	}
	...
	function render($options, $defaults, $content) {
        ...
        $shortcode = '[wpc_reservation_with_food wpc_food_menu_list '.$atts_string.']';
